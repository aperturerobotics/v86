...
export function Ne2k(
    ...
    io.register_write(this.port | EN0_TXCR, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/0d ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_DCFG, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/0e ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_RCNTLO, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/0a ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_RCNTHI, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/0b ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_RSARLO, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/08 ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_RSARHI, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/09 ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_IMR, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg' + pg + '/0f ' + h(data_byte, 2),
                LOG_NET,
            )
        }
    })
    ...
    io.register_write(this.port | EN0_TCNTLO, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg3/05 (CONFIG2): ' + h(data_byte),
                LOG_NET,
            )
        } else {
    ...
    io.register_write(this.port | EN0_TCNTHI, this, function (data_byte) {
        ...
        if (pg === 0) {
            ...
            dbg_log(
                'Unimplemented: Write pg3/06 (CONFIG3): ' + h(data_byte),
                LOG_NET,
            )
        } else {
