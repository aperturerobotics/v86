 ...
 */
IO.prototype.register_read_consecutive = function (
    port_addr,
    device,
    r8_1,
    r8_2,
 ...
 */
IO.prototype.register_write_consecutive = function (
    port_addr,
    device,
    w8_1,
    w8_2,
 ...
 * @param {*=} write_func32
 */
IO.prototype.mmap_register = function (
    addr,
    size,
    read_func8,
    write_func8,
...
IO.prototype.port_read8 = function (port_addr) {
    ...
    if (value < 0 || value >= 0x100)
        dbg_assert(false, '8 bit port returned large value: ' + h(port_addr))
    return value
}
...
IO.prototype.port_read16 = function (port_addr) {
    ...
    if (value < 0 || value >= 0x10000)
        dbg_assert(false, '16 bit port returned large value: ' + h(port_addr))
    return value
}
