 ...
 */
FileStorageInterface.prototype.read = function (
    sha256sum,
    offset,
    count,
    file_size,
 ...
 */
export function ServerFileStorageWrapper(
    file_storage,
    baseurl,
    zstd_decompress,
) {
 ...
 */
ServerFileStorageWrapper.prototype.load_from_server = function (
    sha256sum,
    file_size,
) {
    return new Promise((resolve, reject) => {
        load_file(this.baseurl + sha256sum, {
                ...
                if (sha256sum.endsWith('.zst')) {
                    data = new Uint8Array(this.zstd_decompress(file_size, data))
                }
 ...
 * @return {!Promise<Uint8Array>}
 */
ServerFileStorageWrapper.prototype.read = async function (
    sha256sum,
    offset,
    count,
    file_size,
