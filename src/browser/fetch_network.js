    ...
    if (this.read && this.read.indexOf('\r\n\r\n') !== -1) {
        ...
        for (let i = 1; i < headers.length; ++i) {
            ...
            if (!header) {
                ...
                this.net.respond_text_and_close(
                    this,
                    400,
                    'Bad Request',
...
FetchNetworkAdapter.prototype.form_response_head = function (
    status_code,
    status_text,
    headers,
) {
...
FetchNetworkAdapter.prototype.respond_text_and_close = function (
    conn,
    status_code,
    status_text,
    body,
