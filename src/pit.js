...
export function PIT(cpu, bus) {
    ...
    cpu.io.register_read(0x40, this, function () {
        return this.counter_read(0)
    })
    cpu.io.register_read(0x41, this, function () {
        return this.counter_read(1)
    })
    cpu.io.register_read(0x42, this, function () {
        return this.counter_read(2)
    })

    cpu.io.register_write(0x40, this, function (data) {
        this.counter_write(0, data)
    })
    cpu.io.register_write(0x41, this, function (data) {
