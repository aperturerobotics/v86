...
SB16.prototype.port2x0_write = function (value) {
    dbg_log(
        '220 write: (unimplemented) fm register 0 address = ' + h(value),
        LOG_SB16,
    )
    this.fm_current_address0 = 0
}
...
SB16.prototype.port2x2_write = function (value) {
    dbg_log(
        '222 write: (unimplemented) fm register 1 address = ' + h(value),
        LOG_SB16,
    )
    this.fm_current_address1 = 0
}
...
SB16.prototype.dma_transfer_next = function () {
    ...
    this.dma.do_write(
        ...
        (error) => {
            dbg_log(
                'dma block transfer ' + (error ? 'unsuccessful' : 'successful'),
                LOG_SB16,
            )
            if (error) return
