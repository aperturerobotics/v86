...
const { V86 } = await import(
    BENCH_COLLECT_STATS ? '../../src/main.js' : '../../build/libv86.mjs'
)
...
if (true) {
    ...
    var emulator = new V86({
        ...
        cmdline:
            'rw console=ttyS0 apm=off root=host9p rootfstype=9p rootflags=trans=virtio,cache=loose mitigations=off audit=0 tsc=reliable nowatchdog init=/usr/bin/init-openrc',
        filesystem: {
            basefs: {
